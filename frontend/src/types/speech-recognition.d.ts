// Minimal typings for the non-standard (webkit-prefixed) Web Speech API
// SpeechRecognition interface -- not part of TypeScript's lib.dom.d.ts.
// SpeechSynthesis/SpeechSynthesisUtterance ARE in lib.dom already, so
